    ...
    <div>
        <div class="main">
            ...
            <div class="main-con">
                <aside class="aside">
                    <div class="basic">
                        <img class="avator" src="//pic.iidingyun.com/1000//file/20181127/75713.png" alt="">
                        <div class="mobile">13411111111</div>
                        <div class="account">账户名：123456</div>
                    </div>
                    <nav class="nav">
                        <router-link class="nav-link" :class="{active:currentRoutePath=='/user/finance'}" to="/user/finance">账务管理</router-link>
                        <router-link class="nav-link" :class="{active:currentRoutePath=='/user/myproject'}" to="/user/myproject">我的项目</router-link>
                        <router-link class="nav-link" :class="{active:currentRoutePath=='/user/message'}" to="/user/message">消息中心</router-link>
                    </nav>
                </aside>
